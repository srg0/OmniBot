...
int main() {
  ...
  std::cout << "brainflow_navigation_checks=" << checks
            << " game_slots=" << static_cast<unsigned>(kReleaseGameSlots) << '\n';
}
